...
export function Portfolio() {
  ...
  // Nothing to show yet (either still loading, or the admin hasn't uploaded
  // any work) — showing a confident "Showcase" heading over an empty,
  // dashed placeholder box reads as unfinished, not as anticipation. Hide
  // the whole section rather than advertise emptiness to real visitors.
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div>
            ...
            <h2 className="text-5xl md:text-6xl font-serif text-[#1A1A1A] mb-4 leading-tight">The Showcase</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {filteredItems.map((item) => (
            <div
              ...
              className="group relative aspect-[4/5] rounded-3xl overflow-hidden cursor-pointer bg-white shadow-sm hover:shadow-2xl transition-all duration-700"
            >
              ...
              <div className="absolute inset-x-4 bottom-4 p-8 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 flex flex-col items-center text-center text-white">
