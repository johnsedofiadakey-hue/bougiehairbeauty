...
export function WhatsAppFloat({ number }: { number?: string }) {
  ...
  return (
    ...
    >
      <div className="absolute -left-32 top-1/2 -translate-y-1/2 bg-white px-4 py-2 rounded-xl shadow-xl border border-luxe-dark/10 opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none whitespace-nowrap text-sm font-medium text-luxe-dark">
        Chat with us!
      </div>
